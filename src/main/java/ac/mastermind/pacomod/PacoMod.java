...
import ac.mastermind.pacomod.Tab.DeportesTab;
...
public class PacoMod
{
    ...
    public PacoMod()
    {
        ...
        //REGISTRAMOS EL TAB
        DeportesTab.DEPORTES_TABS.register(modEventBus);
    ...
    private void addCreative(BuildCreativeModeTabContentsEvent event)
    {
        ...
        if(event.getTab() == DeportesTab.DEPORTE_TAB.get()){
            ...
            event.accept(OtrosItems.LIQUIDO_ITEM);
        }
    }
